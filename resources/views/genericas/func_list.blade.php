    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <button type="button" class="btn btn-block btn-info <?php echo $class_btn_accion ?>" data-toggle="modal" data-target="#modal-<?php echo $gen_modelo ?>_<?php echo $random_id_table ?>" onclick="crearABM_<?php echo $gen_modelo ?>_<?php echo $random_id_table ?>('a', -1)" style="max-width: 400px"><i class="fa fa-plus"></i> <?php echo __('Agregar') ?></button>
          <?php } ?>
        </div>
        <!-- /.col -->
      </div>
