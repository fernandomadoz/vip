...
<head>
  ...
  <title>VIP | Multi Generator</title>
  ...
  <link rel="stylesheet" href="<?php echo env('PATH_PUBLIC')?>bower_components/Responsive/css/responsive.bootstrap.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo env('PATH_PUBLIC')?>" class="logo">
      ...
      <span class="logo-mini"><b><i class="fa fa-send-o"></i></b></span>
      <!-- logo for regular state and mobile devices -->
      <i class="fa fa-credit-card"></i> VIP</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if (in_array($nivel_de_acceso, $permiso_supervisor)) { ?>
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <?php if (in_array($nivel_de_acceso, $permiso_supervisor)) { ?>
              <li><a href="<?php echo env('PATH_PUBLIC')?>tarjetas"><i class="fa fa-credit-card"></i> Tarjetas</a></li> 
            <?php } ?>
          </ul>
        </li>
        <?php } ?>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <?php if (in_array($nivel_de_acceso, $permiso_administrador)) { ?>
              ...
              <li><a href="<?php echo env('PATH_PUBLIC')?>list/Opcion/0"><i class="fa fa-circle-thin"></i> Opciones</a></li>   
            <?php } ?>
          </ul>
        </li>
        <?php } ?>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li><a href="#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-send-o"></i></a></li>
...
<script type="text/javascript" language="javascript" src="<?php echo env('PATH_PUBLIC')?>bower_components/Responsive/js/dataTables.responsive.js"></script>
